package com.kabigon.board.controller;
...
public class BoardController {
	...
	// 수정은 이전에 보고 있던 목록 보기로 돌아갈 수 있어야 하기 때문에 목록 보기에 필요한 데이터가 필요합니다.
	...
	public String remove(Long bno, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("msg", bno + " 삭제 완료");
