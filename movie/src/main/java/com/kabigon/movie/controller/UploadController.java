package com.kabigon.movie.controller;
...
import com.kabigon.movie.dto.UploadResultDTO;
...
public class UploadController {
	// application.properties 파일에 있는 com.kabigon.upload.path라는 속성에 설정된 값 가져오기
	@Value("${com.kabigon.upload.path}")
